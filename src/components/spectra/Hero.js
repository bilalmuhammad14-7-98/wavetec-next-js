        ...
        <div className="relative z-10 flex flex-col items-center md:flex-row gap-8 justify-between">
          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            <h1 className="text-3xl sm:text-4xl xl:text-6xl font-bold text-[#181D27] dark:text-[#F7F7F7] mb-8 leading-tight">
              ...
              to grow smarter */}
              Spectra: Enterprise Level Queue Management Software 
            </h1>

            <p className="text-lg md:text-xl font-normal text-[#535862] dark:text-[#94979C] mb-6 leading-relaxed">
              Spectra transforms how your business operates at the front line, where customers are.
              With our powerful queue management system built into our hardware, you stay in central
              control of the customer journey from start to finish.
            </p>
            ...
            <div className="flex flex-col sm:flex-row sm:justify-start justify-center gap-4 mb-12">
              <ButtonOne
                ...
                icon={<TfiHeadphoneAlt className="mr-2 h-5 w-5 text-[#A4A7AE]" />}
                className="flex items-center justify-center "
              />
              <ButtonTwo
                title={'Download Brochure'}
                icon={<IoBookSharp className="mr-2 h-5 w-5 text-[#A4A7AE]" />}
                className="flex items-center justify-center "
              />
            </div>
