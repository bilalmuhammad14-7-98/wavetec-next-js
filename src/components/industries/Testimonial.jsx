...
export default function Testimonial() {
  return (
    <section className="bg-white dark:bg-[#0C0E12] py-20 px-4 text-center">
      <div className="max-w-3xl mx-auto flex flex-col items-center space-y-6">
        {/* Company Logo */}
        <div className="flex items-center justify-center gap-2">
          <Image src={Logomark} alt="Company Logo" className="w-10 h-10 object-contain" priority />
          <span className="text-lg font-semibold text-gray-800 dark:text-white">Wildcrafted</span>
        </div>
